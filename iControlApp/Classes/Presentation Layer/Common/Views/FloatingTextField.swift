...
open class FloatingTextField: UITextField { // swiftlint:disable:this type_body_length
    ...
    fileprivate func updatePlaceholder() {
        ...
        let color = isEnabled ? placeholderColor : disabledPlaceholderColor
        #if swift(>=4.2)
    ...
    var disabledPlaceholderColor: UIColor = .darkGray {
        didSet {
            updateControl()
            updatePlaceholder()
        }
    ...
    */
    ...
    fileprivate func updateTitleColor() {
        ...
        if !isEnabled {
            titleLabel.textColor = disabledPlaceholderColor
        } else if hasErrorMessage {
